...
<body style="background-color: #e6f2ff">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      ?>
      <li class="nav-item">
        <a class="nav-link" href="http://www.swaasthya.co/aboutUs.php">About us</a>
      </li>
      <?php
      if (isset($_POST['booking'])) {
        header("Location:http://www.swaasthya/booking/booking.php");
      }
      ?>
    </ul>
  </div>
...
echo "<input type='text' autocomplete='off' placeholder='Search for hospital...' name='search'>";
