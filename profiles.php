...
<div style="padding: 10px; width: 100%;">
  <?php 
  if($_COOKIE['profile_id']!="0" &&$_COOKIE['profile_id']==$_COOKIE['user_id']){
  ?>
  ...
  <table style="width: 100%;">
    <tr>
      ...
      <td>
        <textarea cols="30" rows="1" placeholder="name"></textarea>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        <input type="text" name="name" placeholder="full address">
      </td>
    </tr>
    <tr>
      <td>
...
<div style="padding: 10px; width: 100%;">
  <?php 
  if($_COOKIE['profile_id']==$_COOKIE['user_id']){
  ?>
  To add a new location:
  <br>
  <table style="width: 100%;">
...
<div style="padding: 20px;">
  <textarea cols="50" rows="1" placeholder="reviews"></textarea>
